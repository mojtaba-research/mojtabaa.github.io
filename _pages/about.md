...
My research focuses on developing dynamic policies, inspection mechanisms, and experimentation frameworks in strategic and uncertain environments. I integrate techniques from online decision-making, statistical inference, and operations research—drawing on tools such as stochastic systems analysis, approximation algorithms, online learning, and large deviation theory. My work also extends to applications in online decision-making, the sharing economy, and automated transportation systems, where I have published several studies. My work has been recognized with honors such as IBM best student paper award finalist (2024) and the Rackham Predoctoral Fellowship (2022).
